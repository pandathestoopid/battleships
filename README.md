...
- **Battleships** have *upgraded guns*, allowing for a buff in one of three traits:
	...
	- *Precision Targeting* allows for greater **accuracy** at the cost of increased **firing cooldown**.
